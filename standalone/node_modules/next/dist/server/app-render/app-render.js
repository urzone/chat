   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
       ...
       */ const walkTreeWithFlightRouterState = async ({ createSegmentPath , loaderTreeToFilter , parentParams , isFirst , flightRouterState , parentRendered , rscPayloadHead , injectedCSS , injectedFontPreloadTags , rootLayoutIncluded , asNotFound  })=>{
         ...
         */ const renderComponentsOnThisLevel = // No further router state available
            ...
            const flightData = (await walkTreeWithFlightRouterState({
                ...
                rscPayloadHead: /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(_metadata.MetadataTree, {
                    key: requestId,
     ...
     */ const ServerComponentsRenderer = (0, _createServerComponentsRenderer).createServerComponentRenderer(async (props)=>{
            ...
            return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(AppRouter, {
                ...
                initialHead: /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(_metadata.MetadataTree, {
                    key: requestId,
        ...
        function InsertedHTML({ children  }) {
            ...
            return /*#__PURE__*/ React.createElement(_headManagerContext.HeadManagerContext.Provider, {
                value: {
                    appDir: true,
                    nonce
                }
            }, /*#__PURE__*/ React.createElement(_serverInsertedHtml.ServerInsertedHTMLContext.Provider, {
        ...
        const bodyResult = (0, _tracer).getTracer().wrap(_constants.AppRenderSpan.getBodyResult, {
            ...
            const getServerInsertedHTML = ()=>{
                ...
                const flushed = (0, _renderToString).renderToString(/*#__PURE__*/ React.createElement(React.Fragment, null, Array.from(serverInsertedHTMLCallbacks).map((callback)=>callback()), polyfillsFlushed ? null : polyfills == null ? void 0 : polyfills.map((polyfill)=>{
            ...
            try {
                ...
                const renderStream = await (0, _nodeWebStreamsHelper).renderToInitialStream({
                    ...
                    element: /*#__PURE__*/ React.createElement("html", {
                        id: "__next_error__"
                    }, /*#__PURE__*/ React.createElement("head", null, /*#__PURE__*/ React.createElement(_metadata.MetadataTree, {
                        key: requestId,
                        metadata: [],
                        pathname: pathname
