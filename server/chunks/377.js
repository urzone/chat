...
var mask_module = __webpack_require__(3884);
...
var mask = __webpack_require__(6910);
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)(ui_lib/* List */.aV, {
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                        title: locales/* default.Mask.Config.Avatar */.ZP.Mask.Config.Avatar,
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* ListItem */.HC, {
                        title: locales/* default.Mask.Config.Name */.ZP.Mask.Config.Name,
...
function ContextPromptItem(props) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            !focusingInput && /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* Select */.Ph, {
...
function ContextPrompts(props) {
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
            ...
            children: [
                context.map((c, i)=>/*#__PURE__*/ jsx_runtime_.jsx(ContextPromptItem, {
                        prompt: c,
...
function MaskPage() {
    ...
    const editingMask = maskStore.get(editingMaskId) ?? app_masks/* BUILTIN_MASK_STORE.get */.$n.get(editingMaskId);
    const closeMaskModal = ()=>setEditingMaskId(undefined);
    const downloadAll = ()=>{
        (0,utils/* downloadAs */.CP)(JSON.stringify(masks), constant/* FileName.Masks */.dJ.Masks);
    };
        ...
        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                        ...
                                        children: locales/* default.Mask.Page.Title */.ZP.Mask.Page.Title
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                        className: "window-header-submai-title",
                                        children: locales/* default.Mask.Page.SubTitle */.ZP.Mask.Page.SubTitle(allMasks.length)
                                    })
                                ]
                            }),
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx("input", {
                                        ...
                                        placeholder: locales/* default.Mask.Page.Search */.ZP.Mask.Page.Search,
                                        autoFocus: true,
                                        onInput: (e)=>onSearch(e.currentTarget.value)
                                    }),
                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)(ui_lib/* Select */.Ph, {
                                        className: (mask_module_default())["mask-filter-lang"],
                                        value: filterLang ?? locales/* default.Settings.Lang.All */.ZP.Settings.Lang.All,
                                        onChange: (e)=>{
                                            const value = e.currentTarget.value;
                                            if (value === locales/* default.Settings.Lang.All */.ZP.Settings.Lang.All) {
                                        ...
                                        children: [
                                            /*#__PURE__*/ jsx_runtime_.jsx("option", {
                                                value: locales/* default.Settings.Lang.All */.ZP.Settings.Lang.All,
                                                children: locales/* default.Settings.Lang.All */.ZP.Settings.Lang.All
                                            }, "all"),
                                            locales/* AllLangs.map */.DC.map((lang)=>/*#__PURE__*/ jsx_runtime_.jsx("option", {
                                                    value: lang,
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                                        ...
                                        icon: /*#__PURE__*/ jsx_runtime_.jsx(add/* default */.Z, {}),
                                        text: locales/* default.Mask.Page.Create */.ZP.Mask.Page.Create,
                                        bordered: true,
                                        onClick: ()=>{
                                        ...
                                        children: [
                                                    ...
                                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                                ...
                                                                children: `${locales/* default.Mask.Item.Info */.ZP.Mask.Item.Info(m.context.length)} / ${locales/* default.Settings.Lang.Options */.ZP.Settings.Lang.Options[m.lang]} / ${m.modelConfig.model}`
                                                            })
                                                        ]
                                                    })
                                                ]
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                                                        icon: /*#__PURE__*/ jsx_runtime_.jsx(add/* default */.Z, {}),
                                                        text: locales/* default.Mask.Item.Chat */.ZP.Mask.Item.Chat,
                                                        onClick: ()=>{
                                                    ...
                                                    m.builtin ? /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                                                        ...
                                                        text: locales/* default.Mask.Item.View */.ZP.Mask.Item.View,
                                                        onClick: ()=>setEditingMaskId(m.id)
                                                    }) : /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                                                        icon: /*#__PURE__*/ jsx_runtime_.jsx(edit/* default */.Z, {}),
                                                        text: locales/* default.Mask.Item.Edit */.ZP.Mask.Item.Edit,
                                                        onClick: ()=>setEditingMaskId(m.id)
                                                    }),
                                                    !m.builtin && /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                                                        icon: /*#__PURE__*/ jsx_runtime_.jsx(icons_delete/* default */.Z, {}),
                                                        text: locales/* default.Mask.Item.Delete */.ZP.Mask.Item.Delete,
                                                        onClick: ()=>{
                                                            if (confirm(locales/* default.Mask.Item.DeleteConfirm */.ZP.Mask.Item.DeleteConfirm)) {
            ...
            editingMask && /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx(ui_lib/* Modal */.u_, {
                    title: locales/* default.Mask.EditModal.Title */.ZP.Mask.EditModal.Title(editingMask?.builtin),
                    onClose: closeMaskModal,
                    actions: [
                        /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                            icon: /*#__PURE__*/ jsx_runtime_.jsx(download/* default */.Z, {}),
                            text: locales/* default.Mask.EditModal.Download */.ZP.Mask.EditModal.Download,
                            bordered: true,
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx(components_button/* IconButton */.h, {
                            ...
                            bordered: true,
                            text: locales/* default.Mask.EditModal.Clone */.ZP.Mask.EditModal.Clone,
                            onClick: ()=>{
...
module.exports = {
	...
	"section-title": "chat_section-title__0FW3o",
	"section-title-action": "chat_section-title-action__NQxSV",
...
// Exports
module.exports = {
	"mask-page": "mask_mask-page__0TaLA",
	"mask-page-body": "mask_mask-page-body__o46mn",
	"mask-filter": "mask_mask-filter__Yi_Ic",
	"slide-in": "mask_slide-in__l7q5v",
	"search-bar": "mask_search-bar__hxd87",
	"mask-filter-lang": "mask_mask-filter-lang__jnFRf",
	"mask-create": "mask_mask-create__xMGqx",
	"mask-item": "mask_mask-item__v_lEk",
	"mask-header": "mask_mask-header__TG9Jc",
	"mask-icon": "mask_mask-icon__wRTWw",
	"mask-title": "mask_mask-title__TAR7_",
	"mask-name": "mask_mask-name__mYbHf",
	"mask-info": "mask_mask-info__OluG7",
	"mask-actions": "mask_mask-actions___oist",
	"slide-in-from-top": "mask_slide-in-from-top__70Uak"
};
