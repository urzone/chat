...
function handleMutable(state, mutable) {
    ...
    return {
        ...
        focusAndScrollRef: {
            ...
            segmentPaths: (ref = mutable == null ? void 0 : mutable.scrollableSegments) != null ? ref : state.focusAndScrollRef.segmentPaths
        },
        // Apply cache.
        ...
        nextUrl: typeof mutable.patchedTree !== "undefined" ? (ref1 = (0, _computeChangedPath).computeChangedPath(state.tree, mutable.patchedTree)) != null ? ref1 : state.canonicalUrl : state.nextUrl
    };
}
if ((typeof exports.default === "function" || typeof exports.default === "object" && exports.default !== null) && typeof exports.default.__esModule === "undefined") {
    Object.defineProperty(exports.default, "__esModule", {
...
var _removeTrailingSlash = __webpack_require__(5107);
...
var _interop_require_default = (__webpack_require__(6356)/* ["default"] */ .Z);
var _react = _interop_require_default(__webpack_require__(8038));
var _loadable = _interop_require_default(__webpack_require__(9560));
...
module.exports = createProxy("/Users/urzone/ChatGPT-Next-Web/node_modules/next/dist/client/components/app-router.js");
 //# sourceMappingURL=app-router.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy  } = __webpack_require__(5985);
module.exports = createProxy("/Users/urzone/ChatGPT-Next-Web/node_modules/next/dist/client/components/error-boundary.js");
 //# sourceMappingURL=error-boundary.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy  } = __webpack_require__(5985);
module.exports = createProxy("/Users/urzone/ChatGPT-Next-Web/node_modules/next/dist/client/components/layout-router.js");
 //# sourceMappingURL=layout-router.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy  } = __webpack_require__(5985);
module.exports = createProxy("/Users/urzone/ChatGPT-Next-Web/node_modules/next/dist/client/components/render-from-template-context.js");
 //# sourceMappingURL=render-from-template-context.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy  } = __webpack_require__(5985);
module.exports = createProxy("/Users/urzone/ChatGPT-Next-Web/node_modules/next/dist/client/components/static-generation-searchparams-bailout-provider.js");
 //# sourceMappingURL=static-generation-searchparams-bailout-provider.js.map
...
[
    ...
    new A(2, a.toLowerCase(), null, !1, !1);
});
"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(a) {
    new A(3, a.toLowerCase(), null, !1, !1);
});
[
    "rowSpan",
    "start"
].forEach(function(a) {
    new A(5, a.toLowerCase(), null, !1, !1);
});
var B = /[\-:]([a-z])/g;
function C(a) {
...
[
    ...
    new A(1, a.toLowerCase(), null, !1, !1);
});
[
    "src",
    "href",
    ...
    new A(1, a.toLowerCase(), null, !0, !0);
});
...
function va(a, b) {
    ...
    a.depth === b.depth ? E(a, b) : va(a, b);
}
function wa(a, b) {
    var d = b.parent;
    if (null === d) throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");
    a.depth === d.depth ? E(a, d) : wa(a, d);
    b.context._currentValue = b.value;
}
function xa(a) {
    var b = D;
    b !== a && (null === b ? ua(a) : null === a ? ta(b) : b.depth === a.depth ? E(b, a) : b.depth > a.depth ? va(b, a) : wa(b, a), D = a);
}
function ya(a, b) {
...
var za = Error("Suspense Exception: This is not a real error! It's an implementation detail of `use` to interrupt the current render. You must either rethrow it immediately, or move the `use` call outside of the `try/catch` block. Capturing without rethrowing will lead to unexpected behavior.\n\nTo handle async errors, wrap your component in an error boundary, or call the promise's `.catch` method and pass the result to `use`");
function Aa() {}
function Ba(a, b, d) {
    d = a[d];
    void 0 === d ? a.push(b) : d !== b && (b.then(Aa, Aa), b = d);
    switch(b.status){
        case "fulfilled":
            return b.value;
        case "rejected":
...
function N(a, b) {
    ...
    if (sa(a)) {
        ...
        for(h = 0; h < g.length; h++){
            ...
            e += ('"' + k + '"' === l ? k : l) + ": ";
            l = a[k];
            l = "object" === typeof l && null !== l ? N(l) : Na(l);
...
var Oa = aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, Pa = Oa.ContextRegistry, Qa = Oa.ReactCurrentDispatcher, Ra = Oa.ReactCurrentCache;
function Sa(a) {
    console.error(a);
}
function Ta(a, b, d, c, e) {
    if (null !== Ra.current && Ra.current !== La) throw Error("Currently React only supports one RSC renderer at a time.");
    Ra.current = La;
    var g = new Set, h = [], k = {
        status: 0,
        fatalError: null,
        ...
        identifierPrefix: e || "",
        identifierCount: 1,
        onError: void 0 === d ? Sa : d,
        toJSON: function(l, v) {
            return Ua(k, this, l, v);
        }
    };
    k.pendingChunks++;
    b = Va(c);
...
function Ya(a, b) {
    a.pendingChunks++;
    var d = Wa(a, null, D, a.abortableTasks);
    switch(b.status){
        case "fulfilled":
            return d.model = b.value, Za(a, d), d.id;
        case "rejected":
            var c = O(a, b.reason);
            Q(a, d.id, c);
            return d.id;
...
function S(a, b, d, c, e, g) {
    ...
    if ("function" === typeof b) {
        ...
        J = g;
        e = b(e);
        return "object" === typeof e && null !== e && "function" === typeof e.then ? "fulfilled" === e.status ? e.value : ab(e) : e;
    }
    ...
    throw Error("Unsupported Server Component type: " + Na(b));
}
function Za(a, b) {
    var d = a.pingedTasks;
    d.push(b);
...
function cb(a, b, d, c) {
    ...
    if (void 0 !== h) return b[0] === y && "1" === d ? "$L" + h.toString(16) : "$" + h.toString(16);
    try {
        ...
        a.pendingChunks++;
        var v = a.nextChunkId++, na = t(l), x = v.toString(16) + ":I" + na + "\n";
        var P = q.encode(x);
        a.completedImportChunks.push(P);
        g.set(e, v);
        return b[0] === y && "1" === d ? "$L" + v.toString(16) : "$" + v.toString(16);
    } catch (oa) {
        return a.pendingChunks++, b = a.nextChunkId++, d = O(a, oa), Q(a, b, d), "$" + b.toString(16);
    }
}
function Ua(a, b, d, c) {
    switch(c){
    ...
    for(; "object" === typeof c && null !== c && (c.$$typeof === y || c.$$typeof === z);)try {
        switch(c.$$typeof){
            case y:
                var e = c;
        ...
        d = h === za ? Ca() : h;
        if ("object" === typeof d && null !== d && "function" === typeof d.then) return a.pendingChunks++, a = Wa(a, c, D, a.abortableTasks), c = a.ping, d.then(c, c), a.thenableState = Da(), "$L" + a.id.toString(16);
        a.pendingChunks++;
        c = a.nextChunkId++;
        d = O(a, d);
        Q(a, c, d);
    ...
    if ("object" === typeof c) {
        if (c.$$typeof === w) return cb(a, b, d, c);
        if ("function" === typeof c.then) return "$@" + Ya(a, c).toString(16);
        ...
        return !sa(c) && (null === c || "object" !== typeof c ? a = null : (a = ra && c[ra] || c["@@iterator"], a = "function" === typeof a ? a : null), a) ? Array.from(c) : c;
    }
            ...
            if (0 === g.status) {
                ...
                try {
                    ...
                    if ("object" === typeof k && null !== k && k.$$typeof === y) {
                        ...
                        for(g.thenableState = null; "object" === typeof k && null !== k && k.$$typeof === y;)l = k, g.model = k, k = S(h, l.type, l.key, l.ref, l.props, null);
                    }
                    var na = da(h, g.id, k);
                    h.completedJSONChunks.push(na);
...
function Va(a) {
    if (a) {
        ...
        for(var d = 0; d < a.length; d++){
            var c = a[d], e = c[0];
            c = c[1];
            Pa[e] || (Pa[e] = aa.createServerContext(e, pa));
            ya(Pa[e], c);
        }
        a = D;
        xa(b);
...
function ib(a) {
    ...
    if (a.async) {
        if (b = gb.get(a.id)) return "fulfilled" === b.status ? null : b;
...
function pb(a, b, d, c) {
    if ("$" === c[0]) switch(c[1]){
        ...
        case "F":
            ...
            c = c.value;
            return lb(a, c.id, c.bound, X, b, d);
        case "u":
            return;
        case "n":
        ...
        default:
            ...
            switch(a.status){
                ...
                case "pending":
                case "blocked":
                    return c = X, a.then(mb(c, b, d), nb(c)), null;
                default:
                    throw a.reason;
            }
    }
...
function qb(a) {
    var b = new Map, d = {
        ...
        _fromJSON: function(c, e) {
            return "string" === typeof e ? pb(d, this, c, e) : e;
        }
    };
    return d;
}
...
exports.decodeReply = function(a, b) {
    var d = qb(b);
    "string" === typeof a ? rb(d, 0, a) : a.forEach(function(c, e) {
        if ("string" === typeof c) rb(d, +e, c);
        else throw Error("Not implemented.");
    });
    ob(d, Error("Connection closed."));
    return Z(d, 0);
};
exports.renderToReadableStream = function(a, b, d) {
    var c = Ta(a, b, d ? d.onError : void 0, d ? d.context : void 0, d ? d.identifierPrefix : void 0);
    if (d && d.signal) {
        var e = d.signal;
        if (e.aborted) fb(c, e.reason);
        else {
            var g = function() {
                fb(c, e.reason);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/urzone/ChatGPT-Next-Web/node_modules/@vercel/analytics/dist/react/index.js`)
